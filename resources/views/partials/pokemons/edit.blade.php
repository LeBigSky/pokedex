    ...
    <div class="container mt-5">
        ...
        <form action="/monster/{{ $monster->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-between mt-5 p-2">
              ...
              <input type="text" name="nom" id="form1Example1" class="form-control" value="{{ $monster->nom }}" />
            ...
            <div class="form-outline mb-4 w-50 ">
                ...
                <div class="form-outline mb-4 w-50">
                    <input type="number" name="level" id="form1Example1" class="form-control" value="{{ $monster->level }}" />
